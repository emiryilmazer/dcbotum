...
if (!['pc','xbl','psn'].includes(args[0])) message.channel.send('**Lütfen Platform Seçin**: `f!fortnite pc | xbl | psn kullanıcıadı` **Örnek**: `f!fortnite pc Dark` ');

if (!args[1]) return message.channel.send('**Lütfen Kullanıcı İsmi Girin**: `f!fortnite pc | xbl | psn kullanıcıadı` **Örnek**: `f!fortnite pc Dark` ');
